  ...
  for l in range(-1,2,1):
    ...
    for l in range(-1,2,1):
      ...
      for l in range(-1,2,1):
        ...
        for l in range(-1,2,1):
          new_m = initial[3] + l
          if (new_i, new_j, new_k, new_m) != initial:
            neighbours.append((new_i, new_j, new_k, new_m))
  return neighbours
  ...
  for j in range(-15,15):
    for k in range(-10,10):
      for m in range(-10,10):
        current_situation[i,j,k,m] = '.'

for i in range(len(puzzle_input_list) - 1,-1,-1):
  for j in range(0, len(puzzle_input_list[i])):
    current_situation[(len(puzzle_input_list) - 1 - i,j,0,0)] = puzzle_input_list[i][j]
